...
# 예를 들어, 자바<font size='2'>Java</font>, C, C++ 등은 키워드 인자 기능을 지원하지 않는다.
# 파이썬 이외에 자바스크립트<font size='2'>JavaScript</font>, C# 등은 키워드 인자를 지원한다.
# 
# 파이썬에서 키워드 인자는 매우 중요하다.
# 나중에 다룰 넘파이, 판다스 라이브러리에 포함된 대다수의 함수가 키워드 인자를 활용한다.
...
# 
# - `book_price(23000)`: 위치 인자를 받는 `price` 매개변수에 대한 인자 23000 만 지정한다.
